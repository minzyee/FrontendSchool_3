...
let s = new Set('abcdeeeeeeee'); // 차집합

console.log(s); // Set(5) {'a', 'b', 'c', 'd', 'e'}
console.log(s.size); // 5 s를 차집한 한 결과의 프로퍼티값 수?
...
// 문제 2 : 각각 몇 개의 게시물을 작성하였나요? --> author를 순회를 돌아볼 생각을 해야합니다.
for (const i of set) {
  console.log(i, 회사게시판.filter(e => e === i)); // data의 갯수를 뽑아낼 때는 filter 사용하기
}
